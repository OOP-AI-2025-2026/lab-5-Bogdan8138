...
public class DrawFrame extends JFrame {
    ...
    private JPanel setButtonPanel() {
        ...
        BigTextButton rounded = new BigTextButton("Rounded rect.");
        rounded.addActionListener(e -> surface.setShapeType(DrawShape.SHAPE_ROUNDED_RECT));
        buttonPanel.add(rounded);
        ...
        clear.addActionListener(e -> surface.clear());
